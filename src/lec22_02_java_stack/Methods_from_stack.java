...
public class Methods_from_stack {
	...
	public static void main(String[] args) {
		...
		System.out.println(stack.contains("MN"));
		...
		// Removes the element at the specified position [index wise] in this Vector.
		System.out.println("\n--------------------------------");
		...
		if(stack.peek().equalsIgnoreCase("mN")) {
			System.out.println("Then you Pop: " + stack.pop());
		}
