...
public class E_learning_string_concatenation {
	public static void main(String[] args) {
		...
		System.out.println("In USA, " + "Janet Yellen, Born in 1946, American economist and Chair of the US Federal Reserve, born in Brooklyn, New York." + " She is the Finanace Minister");
